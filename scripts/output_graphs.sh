...
for flight in "${flights[@]}"; do
  graph_spatial_rsrp_correlation --flight-id "$flight" --label RSRP --save-path /home/ryan/GradProject/DatasetWorkspace/aerpaw-datasets/src/aerpaw_processing/graph/radial_correlation/$flight
done
