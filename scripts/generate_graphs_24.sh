...
# generate-graphs -d 24 -f pawprints_4G_LTE_altitude30m_flight1.csv,pawprints_4G_LTE_altitude50m.csv -k -a -g rsrp,rsrq
generate-graphs -d 24 -f pawprints_4G_LTE_altitude30m_flight1.csv -t -g rsrp --time-col companion_abs_time -a --relative